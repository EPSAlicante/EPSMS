...
#
# check_file_age2.pl Copyright (C) 2009 Klavs Klavsen <klavs@enableit.dk>
#
...
my ($opt_c, $opt_f, $opt_w, $opt_C, $opt_W, $opt_h, $opt_V, $opt_n);
...
GetOptions(
        ...
        "n=f" => \$opt_n, "not-found-ok=f" => \$opt_n,
...
if ( -e $opt_f ) {
        ...
        print "FILE_AGE $result: $opt_f not found\n";
}
...
sub print_usage () {
        print "Usage:\n";
        print "  $PROGNAME [-w <secs>] [-c <secs>] [-W <size>] [-C <size>] [-n <0|1>] -f <file>\n";
...
sub print_help () {
        ...
        print_usage();
        print "\n";
        print "  <secs>  File must be more than this many seconds old (default: warn 259200 secs, crit 86400)\n";
